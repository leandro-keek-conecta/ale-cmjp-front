    ...
    <Box sx={{ display: "flex", minHeight: "100dvh", bgcolor: "#f5f5f5" }}>
      ...
      <Box
        ...
        sx={{
          ...
          overflowX: "hidden",
          width: barraLateralAberta ? "15.281vw" : "50px",
          bgcolor: "#ffffff",
      ...
      <Box
        ...
        sx={{
          ...
          ml: { xs: 0, md: barraLateralAberta ? "15.281vw" : "50px" },
          transition: "all 0.3s ease-in-out",
          overflowX: "hidden",
        }}
      >
        <CabecalhoEstilizado
          ...
          sx={{
            ...
            left: { xs: 0, md: barraLateralAberta ? "15.281vw" : "50px" },
            width: {
              xs: "100%",
              md: `calc(100% - ${barraLateralAberta ? "15.281vw" : "50px"})`,
            },
