...
import FormConstructor from "@/pages/formConstructor/FormConstructor";
...
const RoutesConfig = () => (
  <AuthProvider>
    <Routes>
      ...
      <Route path="/forms-constructor" element={<ProtectedRoute allowedRoles={["USER", "ADMIN", "SUPERADMIN"]}><FormConstructor /></ProtectedRoute>} />
